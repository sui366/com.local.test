 ...
 * @Description: TODO 游牧星空 使命召唤
 * @author: xf.sui
 * @date: 2017年3月6日 下午6:16:10
 */

public class SmzhNewsProcessor implements PageProcessor{

	private SpiderDataService spiderDataService;
	
	public SmzhNewsProcessor(SpiderDataService spiderDataService){
...
//  @Test
//	public void start() {
//		Spider.create(new SmzhNewsProcessor()).addUrl("http://ow.gamersky.com/new/").run();
//	}
}
