 ...
 * @Description: TODO 有意思吧 一些段子
 * @author: xf.sui
 * @date: 2017年3月6日 下午6:16:10
 * 
 */

public class ForgeProcessor extends ParamsProcessor implements PageProcessor{

	
    public ForgeProcessor(SpiderDataService spiderDataService, SpiderTypeService spiderTypeService, Integer taskId, Integer typeId) {
    ...
    public void process(Page page) { 
    	...
    	for(String sidebar:sidebars){
    		...
    		String h2 =  new Html(sidebar).xpath("//h2/text()").toString();
    		
    		if(null != h2 && h2.contains("一些段子")){
