...
/**
 * 
 * @Description: TODO 游牧星空  公共
 * @author: xf.sui
 * @date: 2017年3月6日 下午6:16:10
 */

public class CommonProcessor extends ParamsProcessor implements PageProcessor{

	
    public CommonProcessor(SpiderDataService spiderDataService, SpiderTypeService spiderTypeService, Integer taskId, Integer typeId) {
    ...
    public void process(Page page) { 
    	...
    	if(CollectionUtils.isEmpty(allLi)){//全量
    		...
    		allLi = new Html(object.toString()).xpath("//li").all();
    	}
